    ...
    <div className="flex flex-col lg:gap-20 md:gap-10 gap-8">
      ...
      <div className="grid grid-cols-12 lg:gap-10 md:gap-10 gap-5">
        {listAdvantage.map((item, idx) => (
          <div
            className="shadow-lg hover:shadow-2xl p-8 hover:cursor-pointer hover:transform hover:translate-y-[-20px] flex flex-col items-center justify-start lg:col-span-3 md:col-span-6 col-span-12"
            key={idx}
          >
